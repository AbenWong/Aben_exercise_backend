...
public class SendSmsAPI {
    public String sendSms(String telNum,String code,String MbString){
        ...
        //替换成你的AK
        final String accessKeyId = "LTAID5rrdZyptXuq";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "zveiUi8fjNEUR7hkKiB1mSIPCdQdog";//你的accessKeySecret，参考本文档步骤2
        ...
        request.setSignName("爱社团短信服务");
        //3，必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
        request.setTemplateCode(MbString);
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        //友情提示:如果JSON中需要带换行符,请参照标准的JSON协议对换行符的要求,比如短信内容中包含\r\n的情况在JSON中需要表示成\\r\\n,否则会导致JSON在服务端解析失败
        HashMap<String, String> codemap = new HashMap<String, String>();
        codemap.put("code", code);
        String s = GsonUtils.toJson(codemap);
